<template>
  <div>
    ...
    <Introduction v-if="showIntroduction" :title="title" :description="description" :gestureType="['scroll-down']"
      :buttonText="startButtonText" :clickThrough="false" :orangeRoute="orangeRoute" :greenRoute="greenRoute"
      @start="handleStart" />
      ...
      <div class="BB140item BB140item-1">
        <div class="BB140item-1-ellipse-1">
          ...
          <div class="BB140item-1-title-4">
            "Didot is an elegant and classic typeface of French origin, evoking the style and sophistication associated
            with Paris. Its fine and high-end characteristics are well-suited to the Parisian aesthetic."
          </div>
        </div>
      </div>
      ...
      <div class="BB140item BB140item-2">
        <div class="BB140item-2-ellipse-1">
          ...
          <div class="BB140item-2-title-4">
            "Paris, with its diverse neighborhoods, offers a moderate density, creating an urban atmosphere without
            being overly compact."
          </div>
        </div>
      </div>
...
.BB140container-2 {
  ...
  /* Ajout d'une transition pour une apparence fluide */
...
.BB140item {
  ...
  width: calc(33.33%);
  /* Ajustez la largeur en fonction du pourcentage sans marge */
  height: calc(50%);
  background-color: inherit;
  /* Hérite de la couleur de fond du container-2 */
  border: inherit;
  /* Hérite du contour du container-2 */
  display: flex;
  align-items: center;
  justify-content: center;
  text-align: center;
...
@media (max-width: 1500px) {
  .BB140item {
    width: calc(50%);
    /* Deux colonnes sans marge lorsque la largeur est réduite */
    height: calc(60%);
  }
}
...
@media (max-width: 800px) {
  .BB140item {
    width: calc(100%);
    /* Une colonne sans marge lorsque la largeur est encore plus réduite */
    height: calc(60%);
  }
}
...
.BB140item-3-ellipse-1 {
  ...
  /* Ajustez la taille de l'image pour qu'elle tienne dans le conteneur */
  background-position: center;
  /* Centrez l'image horizontalement et verticalement */
  width: 80%;
  /* Ajustez la largeur du conteneur selon vos besoins */
  height: 80%;
  /* Ajustez la hauteur du conteneur selon vos besoins */
}

.BB140item-1-ellipse-1 {
  background-image: url('@/assets/Cities/typoabc.webp');
  /* Remplacez 'votre-image.jpg' par le chemin de votre image */
  background-size: auto 22%;
}

.BB140item-2-ellipse-1 {
  background-image: url('@/assets/Cities/densite.webp');
  /* Remplacez 'votre-image.jpg' par le chemin de votre image */
}

.BB140item-3-ellipse-1 {
  background-image: url('@/assets/Cities/mouvement.webp');
  /* Remplacez 'votre-image.jpg' par le chemin de votre image */
}
...
.BB140item-4-ellipse-1 {
  background-image: url('@/assets/Cities/pipette.webp');
  /* Remplacez 'votre-image.jpg' par le chemin de votre image */
  background-size: auto 10%;
  background-repeat: no-repeat;
  /* Ajustez la taille de l'image pour qu'elle tienne dans le conteneur */
  background-position: 78% 9%;
  /* Centrez l'image horizontalement et verticalement */
...
.BB140item-4-color-4::before {
  ...
  /* Ajustez la hauteur selon vos besoins */
  margin-right: 10px;
  /* Marge entre le rectangle et le texte */
  background-color: red;
  /* Couleur du rectangle (par défaut, rouge) */
}

.BB140item-4-color-1::before {
  background-color: rgb(233, 182, 187);
  /* Remplacez Color1 par la couleur correspondante */
}

.BB140item-4-color-2::before {
  background-color: rgb(173, 216, 230);
  /* Remplacez Color2 par la couleur correspondante */
}

.BB140item-4-color-3::before {
  background-color: rgb(50, 50, 50);
  /* Remplacez Color3 par la couleur correspondante */
}

.BB140item-4-color-4::before {
  background-color: rgb(255, 250, 240);
  /* Remplacez Color4 par la couleur correspondante */
}
...
.BB140item-5-ellipse-1 {
  background-image: url('@/assets/Cities/localisation.webp');
  /* Remplacez 'votre-image.jpg' par le chemin de votre image */
...
@media (min-width: 1350px) {
  ...
  .BB140item-6 .BB140item-6-ellipse-1 {
    ...
    z-index: 1;
    transition: top 0.3s ease, left 0.3s ease, width 0.3s ease, height 0.3s ease, border-radius 0.3s ease, background-size 0.3s ease, background-position 0.3s ease;
    /* Ajout de l'effet de transition pour le changement de top, left, width et height */
  }
  ...
  .BB140item-3:hover .BB140item-3-ellipse-1 {
    ...
    width: 90%;
    height: 80%;
    transition: top 0.1s ease, left 0.1s ease, width 0.1s ease, height 0.1s ease, border-radius 0.1s ease;
    /* Ajout de l'effet de transition pour le changement de top, left, width et height */
  ...
  .BB140item-5-title-6:hover .BB140item-5-ellipse-6 {
    ...
    /* Mélangez les couleurs pour que le texte reste visible */
  }
...
.BB144item-4-color-1::before {
  background-color: rgb(204, 78, 92);
  /* Remplacez Color1 par la couleur correspondante */
}
