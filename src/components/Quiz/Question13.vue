<template>
    <div class="responses">
      ...
      <div @click="handleClick(false, 3)" :class="{'response': true, 'response-incorrect': clickedIncorrect[3]}">
        <span>{{ response4 }}</span>
      </div>
  ...
  export default {
    data() {
      return {
        response1: "I want you to electrocute me",
        response2: "I want you to send a message to a serial killer who can come and kill me",
        response3: "I want you to keep me so addicted that I won't be able to take my eyes off you",
        response4: "I want you to direct me to a Slaughterhouse using Google Maps",
        clickedIncorrect: [false, false, false, false],
