...
<template>
  ...
  @keyframes moveTextaround2 {
    0% {
      opacity: 0%;
      word-spacing: 70px; /* Augmente le word-spacing pour les petits écrans */
    }
    100% {
      opacity: 100%;
      word-spacing: 10px; /* Ajustez cette valeur selon vos besoins */
    }
  }
}
  </style>
